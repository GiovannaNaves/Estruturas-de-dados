...
int main( int argc, char ** argv) { 
    ...
    for (int n = 1; n <= max; n++){
        ...
        printf("Fatorial iterativo de %d: executou em %lfs de usuario, em %lfs de sistema e %lf de relogio.\n", n, it_user_time, it_sys_time, it_clock_time);
        printf("Fatorial recursivo de %d: executou em %lfs de usuario, em %lfs de sistema e %lf de relogio.\n", n, rec_user_time, rec_sys_time, rec_clock_time);
    }
    printf("Fatorial iterativo de 1 a %d: executou em %lfs de usuario, em %lfs de sistema e %lf de relogio.\n", max, total_it_user_time, total_it_sys_time, total_it_clock_time);
    printf("Fatorial recursivo de 1 a %d: executou em %lfs de usuario, em %lfs de sistema e %lf de relogio.\n", max, total_rec_user_time, total_rec_sys_time, total_rec_clock_time);
}
